...
<div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item"><a href="/" class="nav-link">list 페이지</a></li>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center">
            <c:if test="${boardPage.currentPage > 1}">
                <li class="page-item">
                    <a class="page-link" href="?page=${boardPage.currentPage - 1}&size=${boardPage.pageSize}&keyword=${param.keyword}" aria-label="Previous">
            ...
            <c:forEach var="i" begin="1" end="${boardPage.totalPages}">
                <li class="page-item ${i == boardPage.currentPage ? 'active' : ''}">
                    <a class="page-link" href="?page=${i}&size=${boardPage.pageSize}&keyword=${param.keyword}">${i}</a>
                </li>
            </c:forEach>
            <c:if test="${boardPage.currentPage < boardPage.totalPages}">
                <li class="page-item">
                    <a class="page-link" href="?page=${boardPage.currentPage + 1}&size=${boardPage.pageSize}&keyword=${param.keyword}" aria-label="Next">
